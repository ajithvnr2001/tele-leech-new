...
class Paths:
    WORK_PATH = "/content/tele-leech-new/BOT_WORK"
    THMB_PATH = "/content/tele-leech-new/colab_leecher/Thumbnail.jpg"
    VIDEO_FRAME = f"{WORK_PATH}/video_frame.jpg"
    HERO_IMAGE = f"{WORK_PATH}/Hero.jpg"
    DEFAULT_HERO =  "/content/tele-leech-new/custom_thmb.jpg"
